...
export function ShareButton({ title, text, inline, url }: ShareButtonProps) {
  ...
  const handleTwitter = () => {
    ...
    window.open(`https://twitter.com/intent/tweet?url=${url}&text=${t}`, "_blank", "noopener,noreferrer,width=600,height=500");
  };
    ...
    return (
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="h-8 w-8 flex items-center justify-center rounded-full bg-muted hover:bg-green-100 text-green-600 transition-colors"
        ...
        <button
          ...
          className="h-8 w-8 flex items-center justify-center rounded-full bg-muted hover:bg-blue-100 text-blue-600 transition-colors"
        ...
        <button
          ...
          className="h-8 w-8 flex items-center justify-center rounded-full bg-muted hover:bg-muted/80 text-foreground transition-colors"
          title="Bagikan via X"
        >
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="inline-flex items-center gap-1.5 shrink-0 rounded-md border border-input bg-background px-3 py-1.5 text-sm font-medium shadow-xs hover:bg-accent hover:text-accent-foreground transition-colors focus-visible:outline-none">
